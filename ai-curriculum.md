...
- [x] **1.2.4** Gradients — vector of partial derivatives, what "gradient descent" literally means
- [x] **1.2.5** Optimization — minimizing a function, why we move against the gradient
- [x] **1.2.6** Convex vs non-convex functions — why it matters for training
      → repo: `04-calculus-for-ml`, `05-chain-rule-and-autodiff`, `18-convex-optimization`

### 1.3 Linear Algebra

- [x] **1.3.1** Vectors — what they are, addition, scaling, geometric intuition
- [x] **1.3.2** Dot product — computed by hand, geometric meaning (angle, similarity)
- [x] **1.3.3** Matrices — what they represent, shapes, notation
- [x] **1.3.4** Matrix-vector multiplication — by hand on 2×2 example
- [x] **1.3.5** Matrix-matrix multiplication — by hand, why the shapes must match
- [x] **1.3.6** Matrix transformations & eigenvalues — what a matrix "does" to space
- [x] **1.3.7** Norms & distances — L1, L2, cosine distance, why they matter
- [x] **1.3.8** Tensor operations — N-dimensional arrays, shape, axes, broadcasting
- [x] **1.3.9** Singular Value Decomposition (SVD) — concept + why it underlies embeddings & compression
- [x] **1.3.10** Dimensionality reduction — PCA from scratch, t-SNE/UMAP concept
- [x] **1.3.11** Linear systems — solving Ax = b
- [x] **1.3.12** Numerical stability — why floating point errors matter in deep learning
...
- [x] **1.4.1** Mean, variance, standard deviation — by hand on a small dataset
